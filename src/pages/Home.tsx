              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative py-3 px-2 sm:px-3 text-xs sm:text-sm font-bold transition-all duration-300 whitespace-nowrap focus:outline-none ${isActive ? 'text-primary' : 'text-slate-500 hover:text-primary/80'
                      }`}
                  >
                    {tab.label}
                    {isActive && (
                      ...
                      <div className="relative w-full h-full flex items-center px-8 sm:px-12 py-8">
                        ...
                        <div className="flex flex-col justify-between h-full z-10 max-w-[55%] gap-4 sm:gap-6">
                          <div className={`space-y-2 sm:space-y-3 text-left ${textColor}`}>
                            {card.featured && (
                              <span className={`inline-block text-[9px] sm:text-xs font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full mb-1 ${isDarkCustomCard
            ...
            <div className="flex flex-col gap-2 pt-2">
              {[
                ...
                <button
                  ...
                  className={`w-full text-left py-3.5 px-4 rounded-xl font-semibold text-sm flex items-center justify-between border transition-all cursor-pointer ${activeInfoTab === tab.id
            ...
            <AnimatePresence mode="wait">
              {activeInfoTab === 'apply' && (
                ...
                >
                  ...
                  <div className="relative bg-[#00a1fe26] border border-[#EBE5FF] p-6 sm:p-8 rounded-[32px] text-left flex flex-col gap-6 hover:shadow-md transition-all duration-300 overflow-hidden">
                    ...
                    <div className="space-y-2 pr-12">
                      <h4 className="font-display font-extrabold text-xl text-[#000000] sm:text-2xl">
                        Personal Loan eligibility
                      </h4>

                      <p className="text-xs text-[#000000] mt-1.5 leading-relaxed">
                  ...
                  <div className="relative bg-[#c9fcdc] border border-[#E1F5E8] p-6 sm:p-8 rounded-[32px] text-left flex flex-col gap-6 hover:shadow-md transition-all duration-300 overflow-hidden">
                    {/* Floating circular icon container */}
                    <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.03)] z-10">
                      <div style={{ transform: 'translate(-5px, 5px)' }}>
                        <svg width="34" height="34" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {activeInfoTab === 'rates' && (
                ...
                >
                  <div className="bg-[#f8f4837f] border border-slate-100 p-6 sm:p-8 rounded-[32px] shadow-[0_4px_35px_rgba(0,0,0,0.02)] text-left w-full h-full flex flex-col justify-between hover:shadow-md transition-all duration-300">
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <h3 className="font-display font-extrabold text-2xl sm:text-3xl text-[#000000] leading-tight">
              ...
              {activeInfoTab === 'time' && (
                <motion.div
                  ...
                  className="w-full h-full"
                >
                  <div className="bg-[#fbcbdc] border border-slate-100 p-6 sm:p-8 rounded-[32px] shadow-[0_4px_35px_rgba(0,0,0,0.02)] text-left w-full h-full flex flex-col justify-between hover:shadow-md transition-all duration-300">
                    <div className="space-y-6">
                      <div className="space-y-2">
                        <span className="inline-block text-[10px] font-bold uppercase tracking-wider text-[#003366] bg-[#003366]/5 px-3 py-1 rounded-full">
                          Timeline
          ...
          <div className="flex justify-center flex-wrap gap-2.5">
            {[
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl font-bold text-xs border transition-all cursor-pointer ${activeFaqCategory === cat.id
                  ? 'bg-primary text-white border-primary shadow-md'
